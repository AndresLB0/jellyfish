...
class Productos extends Validator
{
    ...
    */
    ...
    public function updateRow($current_image)
    {
        ...
        $sql = 'UPDATE producto
                SET imagen_producto = ?, nombre = ?, descripcion = ?, precio = ?, estado = ?, id_marca = ?,idtipo_producto=?,existencias=?
                WHERE id_producto = ?';
        $params = array($this->imagen, $this->nombre, $this->descripcion, $this->precio, $this->estado, $this->marca, $this->tipoproducto, $this->existencias, $this->id);
        return Database::executeRow($sql, $params);
    }
    ...
    {
        $sql = 'SELECT id_producto, imagen_producto, nombre, descripcion, precio
